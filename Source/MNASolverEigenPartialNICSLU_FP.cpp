...
MnaSolverEigenPartialNICSLU_FP<VarType>::MnaSolverEigenPartialNICSLU_FP(String name, 
CPS::Domain domain, 
CPS::Logger::Level logLevel) :	MnaSolverEigenNICSLU<VarType>(name, domain, logLevel) {
}
template <typename VarType>
void MnaSolverEigenPartialNICSLU_FP<VarType>::stampVariableSystemMatrix() {
...
template <typename VarType>
void MnaSolverEigenPartialNICSLU_FP<VarType>::solveWithSystemMatrixRecomputation(Real time, Int timeStepCount) {
...
template <typename VarType>
void MnaSolverEigenPartialNICSLU_FP<VarType>::recomputeSystemMatrix(Real time) {
...
template class DPsim::MnaSolverEigenPartialNICSLU_FP<Real>;
template class DPsim::MnaSolverEigenPartialNICSLU_FP<Complex>;