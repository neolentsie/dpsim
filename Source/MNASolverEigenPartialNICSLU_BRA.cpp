...
MnaSolverEigenPartialNICSLU_BRA<VarType>::MnaSolverEigenPartialNICSLU_BRA(String name, 
CPS::Domain domain, 
CPS::Logger::Level logLevel) :	MnaSolverEigenNICSLU<VarType>(name, domain, logLevel) {
}
template <typename VarType>
void MnaSolverEigenPartialNICSLU_BRA<VarType>::stampVariableSystemMatrix() {
	...
	this->mLuFactorizationVariableSystemMatrix.analyzePatternBRA(this->mVariableSystemMatrix, this->mListVariableSystemMatrixEntries);
	auto start = std::chrono::steady_clock::now();
	this->mLuFactorizationVariableSystemMatrix.factorize_fpartial(this->mVariableSystemMatrix, this->mListVariableSystemMatrixEntries);
...
template <typename VarType>
void MnaSolverEigenPartialNICSLU_BRA<VarType>::solveWithSystemMatrixRecomputation(Real time, Int timeStepCount) {
...
template <typename VarType>
void MnaSolverEigenPartialNICSLU_BRA<VarType>::recomputeSystemMatrix(Real time) {
	...
	this->mLuFactorizationVariableSystemMatrix.refactorize_partialBRA(this->mVariableSystemMatrix);
	auto end = std::chrono::steady_clock::now();	
	std::chrono::duration<double> diff = end-start;
...
template class DPsim::MnaSolverEigenPartialNICSLU_BRA<Real>;
template class DPsim::MnaSolverEigenPartialNICSLU_BRA<Complex>;