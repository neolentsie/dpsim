...
#include <dpsim-models/EMT/EMT_Ph3_VSIVoltageControlDroop.h>

using namespace CPS;


EMT::Ph3::VSIVoltageControlDroop::VSIVoltageControlDroop(String uid, String name, Logger::Level logLevel, Bool withTrafo) :
	CompositePowerComp<Real>(uid, name, true, true, logLevel),
    mOmegaSys(Attribute<Real>::create("Omega_sys", mAttributes)),
...
void EMT::Ph3::VSIVoltageControlDroop::setParameters(Real sysOmega, Real VdRef, Real VqRef, Real PowerSet) {
	mParametersSet = true;
...
void EMT::Ph3::VSIVoltageControlDroop::setTransformerParameters(Real nomVoltageEnd1, Real nomVoltageEnd2, Real ratedPower, 
...
void EMT::Ph3::VSIVoltageControlDroop::setControllerParameters(Real Kp_voltageCtrl, Real Ki_voltageCtrl, Real Kp_currCtrl, Real Ki_currCtrl, Real Omega_nominal, Real PowerSet) {

	mSLog->info("Control Parameters:");
	mSLog->info("Droop: Omega_Nom = {}", Omega_nominal);
...
void EMT::Ph3::VSIVoltageControlDroop::setFilterParameters(Real Lf, Real Cf, Real Rf, Real Rc) {
...
void EMT::Ph3::VSIVoltageControlDroop::setInitialStateValues(Real phi_dInit, Real phi_qInit, Real gamma_dInit, Real gamma_qInit) {
...
void EMT::Ph3::VSIVoltageControlDroop::initializeFromNodesAndTerminals(Real frequency) {
	...
	**mElecPassivePower = ( 3./2. * intfVoltageComplex(0,0) *  std::conj( - intfCurrentComplex(0,0)) ).imag();
	...
	if(mWithConnectionTransformer)
	{
		...
		// current and voltage inputs to Droop and voltage controller
		Matrix vcdq, ircdq;
...
void EMT::Ph3::VSIVoltageControlDroop::mnaParentInitialize(Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
	mTimeStep = timeStep;
...
void EMT::Ph3::VSIVoltageControlDroop::addControlPreStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes) {
...
void EMT::Ph3::VSIVoltageControlDroop::controlPreStep(Real time, Int timeStepCount) {
...
void EMT::Ph3::VSIVoltageControlDroop::addControlStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes) {
...
Matrix EMT::Ph3::VSIVoltageControlDroop::parkTransformPowerInvariant(Real theta, const Matrix &fabc) {
...
Matrix EMT::Ph3::VSIVoltageControlDroop::getParkTransformMatrixPowerInvariant(Real theta) {
...
Matrix EMT::Ph3::VSIVoltageControlDroop::inverseParkTransformPowerInvariant(Real theta, const Matrix &fdq) {
...
Matrix EMT::Ph3::VSIVoltageControlDroop::getInverseParkTransformMatrixPowerInvariant(Real theta) {
...
void EMT::Ph3::VSIVoltageControlDroop::controlStep(Real time, Int timeStepCount) {
...
void EMT::Ph3::VSIVoltageControlDroop::mnaParentAddPreStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes) {
...
void EMT::Ph3::VSIVoltageControlDroop::mnaParentPreStep(Real time, Int timeStepCount) {
...
void EMT::Ph3::VSIVoltageControlDroop::mnaParentAddPostStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes, Attribute<Matrix>::Ptr &leftVector) {
	attributeDependencies.push_back(leftVector);
	modifiedAttributes.push_back(mIntfVoltage);
	modifiedAttributes.push_back(mIntfCurrent);
}

void EMT::Ph3::VSIVoltageControlDroop::mnaParentPostStep(Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
	mnaUpdateCurrent(**leftVector);
	mnaUpdateVoltage(**leftVector);
}

//Current update
void EMT::Ph3::VSIVoltageControlDroop::mnaUpdateCurrent(const Matrix& leftvector) {
	if (mWithConnectionTransformer)
...
//Voltage update
void EMT::Ph3::VSIVoltageControlDroop::mnaUpdateVoltage(const Matrix& leftVector) {
