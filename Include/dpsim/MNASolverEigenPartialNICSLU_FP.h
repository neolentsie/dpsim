...
namespace DPsim {
	...
	class MnaSolverEigenPartialNICSLU_FP : public MnaSolverEigenNICSLU<VarType> {
		protected:
		...
		public:
		MnaSolverEigenPartialNICSLU_FP(String name,
			CPS::Domain domain = CPS::Domain::DP,
			CPS::Logger::Level logLevel = CPS::Logger::Level::info);

		/// Destructor
		virtual ~MnaSolverEigenPartialNICSLU_FP() { };
		...
		public:
			...
			SolveTaskRecomp(MnaSolverEigenPartialNICSLU_FP<VarType>& solver) :
		...
		private:
			MnaSolverEigenPartialNICSLU_FP<VarType>& mSolver;
		};
	};
}